...
ARG NEXT_PUBLIC_CHATBOT_SSE_ENABLED
...
ENV NEXT_PUBLIC_CHATBOT_SSE_ENABLED=${NEXT_PUBLIC_CHATBOT_SSE_ENABLED}
...
# Copy assets into the locations the standalone server expects
