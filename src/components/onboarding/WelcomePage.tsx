  ...
  return (
    <div className="px-4 py-8 sm:px-6 lg:px-8" data-testid="welcome-page">
      <div className="mx-auto flex min-h-[calc(100vh-8rem)] max-w-3xl items-center">
        <section className="w-full overflow-visible rounded-xl border border-border/70 bg-card shadow-sm backdrop-blur-sm sm:p-8">
          <div className="mx-auto max-w-xl py-12">
            <h1 className="text-3xl font-black text-foreground sm:text-4xl px-2">
